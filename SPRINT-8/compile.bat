...
if exist "%FRAMEWORK_DIR%\target\sprint8-core.jar" (
    copy /Y "%FRAMEWORK_DIR%\target\sprint8-core.jar" "%TEST_DIR%"
...
if errorlevel 1 (
    ...
    echo Verifiez le chemin: C:\Users\Zed\Documents\GitHub\Projet_sprint8\test
    pause
    exit /b 1
)
...
set WAR_FILE=target\sprint8-core.war
