...
if exist "%FRAMEWORK_DIR%\target\sprint4-core.jar" (
    copy /Y "%FRAMEWORK_DIR%\target\sprint4-core.jar" "%TEST_DIR%"
...
cd /d "D:\S5\Mr Naina\Projet_Sprint4\test"

if errorlevel 1 (
    echo ❌ ERREUR: Impossible d'acceder au dossier test
    echo Verifiez le chemin: D:\S5\Mr Naina\Projet_Sprint4\test
    pause
    exit /b 1
)
...
set WAR_FILE=target\sprint4.war
