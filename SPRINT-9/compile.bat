...
if exist "%FRAMEWORK_DIR%\target\sprint9-core.jar" (
    copy /Y "%FRAMEWORK_DIR%\target\sprint9-core.jar" "%TEST_DIR%"
...
cd /d "C:\Users\Zed\Documents\GitHub\Projet_Sprint9\test"

if errorlevel 1 (
    echo ❌ ERREUR: Impossible d'acceder au dossier test
    echo Verifiez le chemin: C:\Users\Zed\Documents\GitHub\Projet_sprint9\test
    pause
    exit /b 1
)
...
set WAR_FILE=target\sprint9-core.war
